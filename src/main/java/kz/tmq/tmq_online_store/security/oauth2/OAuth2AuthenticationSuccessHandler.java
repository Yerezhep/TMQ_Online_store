...
import kz.tmq.tmq_online_store.exception.auth.BadRequestException;
...
import static kz.tmq.tmq_online_store.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
//        getRedirectStrategy().sendRedirect(request, response, targetUrl);
        ...
        String redirectUri = "http://localhost:8080//api/v1/profile";
        String uri = UriComponentsBuilder.fromUriString(redirectUri)
